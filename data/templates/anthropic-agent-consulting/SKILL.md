...
Use this template when the user selects `anthropic-agent-consulting` in ppt agent.

- Template kind: `deck-derived`
- Strength: Reusable style distilled from a finished PowerPoint deck.
